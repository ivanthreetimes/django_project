...
urlpatterns = [
    ...
    path('register/', app_user_views.register, name='register'),
    ...
    path('password-reset/', auth_views.PasswordResetView.as_view(template_name='app_users/password_reset.html'),
         name='password_reset'),
